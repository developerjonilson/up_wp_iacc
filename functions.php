...
register_nav_menu('menu-princiapl', 'Menu Principal');
...
function custom_post_parceiros() {
	...
	$labels = array(
		...
		'view_items'            => __( 'Visualizar Parceiros', 'text_domain' ),
		'search_items'          => __( '', 'text_domain' ),
		'not_found'             => __( 'Não encontrado', 'text_domain' ),
		'not_found_in_trash'    => __( '', 'text_domain' ),
		'featured_image'        => __( 'Logo do Parceiro', 'text_domain' ),
		'set_featured_image'    => __( 'Selecionar Logo do Parceiro', 'text_domain' ),
		'remove_featured_image' => __( 'Remover Logo do Parceiro', 'text_domain' ),
		'use_featured_image'    => __( 'Usar como Logo do Parceiro', 'text_domain' ),
		'insert_into_item'      => __( '', 'text_domain' ),
		'uploaded_to_this_item' => __( '', 'text_domain' ),
		'items_list'            => __( '', 'text_domain' ),
		'items_list_navigation' => __( '', 'text_domain' ),
